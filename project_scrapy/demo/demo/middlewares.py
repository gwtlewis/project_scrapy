...
class JavaScriptMiddleware(object):
    def process_request(self, request, spider):
        if spider.name == "demo":
            ...
            wait = ui.WebDriverWait(driver, 15)  # 设置等待事件，等待事件为15ms
            ...
            time.sleep(1)
            driver.find_element_by_xpath('xpath of element').click()
            wait.until(lambda driver: driver.find_element_by_xpath('xpath of element'))
